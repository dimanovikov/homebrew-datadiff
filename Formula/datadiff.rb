class Datadiff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.3.0/datadiff-v0.3.0-aarch64-apple-darwin.tar.gz"
    ...
    on_intel do
      ...
      url "https://github.com/dimanovikov/datadiff/archive/refs/tags/v0.3.0.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.3.0/datadiff-v0.3.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "6d38ba1675880205cc33eb4ed7a4817b7596cb678e7acf05b13cd0e07e734007"
    end
    on_arm do
      url "https://github.com/dimanovikov/datadiff/releases/download/v0.3.0/datadiff-v0.3.0-aarch64-unknown-linux-gnu.tar.gz"
